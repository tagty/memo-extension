...
### アクセシビリティ
- [x] キーボードショートカットの追加
  - Alt+Shift+M でポップアップを開く（カスタマイズ可能）
  - chrome://extensions/shortcuts から変更可能
- [ ] 追加のキーボードショートカット
...
- [ ] スクリーンリーダー対応
  - 適切なARIAラベルの追加
- [x] フォーカス管理の改善
  - ポップアップ開始時にtextareaに自動フォーカス（useRefとuseEffectで実装）
...
- [x] キーボードショートカット機能の追加
  - Alt+Shift+M でポップアップを開く
  - manifest.jsonにcommandsセクションを追加
  - chrome://extensions/shortcuts からカスタマイズ可能
- [x] フォーカス管理の改善
